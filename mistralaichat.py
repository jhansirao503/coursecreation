...
def handle_query(request: QueryRequest):
    try:
        ...
        provide a course outline WITHIN 30 SEC with 1 module. module should have a meaningful title and needs 
        to have a minimum of 2 lessons with a major concept to cover.  
        Under each lesson, identify all the major topics at least 2 which includes '''+request.topic+''' and print topic title.
        Under each topic, print comprehensive list of Sub-Topics with title  under each topic.


Course outline has to be exactly in the following format:
*** 1: [Module Title] ***
	** 1.1: [Lesson Title] **
		* 1.1.1: [Topic Title] *
			+ [Sub-Topic Title] +
    ...
    SHOULD REPEAT THIS ITERATION FOR NEXT lESSON '''
